...
const State = struct {
    ...
    pub fn moveInHallway(self: State, from: usize, to: usize) ?State {
    ...
    pub fn enterRoom(self: State, room: Cell) ?State {
    ...
    pub fn leaveRoom(self: State, room: Cell) ?State {
    ...
    pub fn move(self: State, energy_bound: usize) usize {
